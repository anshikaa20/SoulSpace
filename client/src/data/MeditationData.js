...
const MeditationData = {
  joy: {
    title: "Joyful Calm 🌞",
    message:
      "Breathe in deeply. Feel the warmth of gratitude filling your chest. Let each breath radiate your happiness outward.",
    exercise:
  ...
  sadness: {
    ...
    message:
      "Close your eyes. Picture gentle waves carrying away your worries. Allow peace to wash over your heart.",
    exercise:
  ...
  anger: {
    title: "Cooling Fire 🔥",
    message:
      "Take slow, steady breaths. With each exhale, release the tension and let calmness replace the flame.",
    exercise:
  ...
  fear: {
    ...
    message:
      "You are safe. Feel the ground beneath you. Let every breath remind you of your strength and stability.",
    exercise:
  ...
  neutral: {
    ...
    message:
      "Take this moment to simply breathe. Neither happy nor sad — just being. That’s the beauty of balance.",
    exercise:
